...
//        var a = this;
//        $.ajax({url: ("https:" == document.location.protocol ? "https://" : "http://") + "passport." + pageConfig.FN_getDomain() + "/new/helloService.ashx?m=ls&rest=0",dataType: "jsonp",success: function(b) {
...
//            a && a.info && $("#loginbar").html(a.info), a && a.rest && $.each(a.rest, function() {
//                $.getJSON(this);
//                
//            })
//        }}), 
